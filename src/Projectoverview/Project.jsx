      ...
      <div className="project-menu-container">
        ...
        {showDropdown === project.id && (
          <div className="project-action-dropdown">
            <div className="project-action-item" onClick={() => handleProjectAction('edit', project.id)}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                <path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/>
              </svg>
              Edit Project
            </div>
            <div className="project-action-item" onClick={() => handleProjectAction('complete', project.id)}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
              </svg>
              Mark as Completed
            </div>
            <div className="project-action-item" onClick={() => handleProjectAction('archive', project.id)}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                <path d="M20.54 5.23l-1.39-1.68C18.88 3.21 18.47 3 18 3H6c-.47 0-.88.21-1.16.55L3.46 5.23C3.17 5.57 3 6.02 3 6.5V19c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6.5c0-.48-.17-.93-.46-1.27zM12 17.5L6.5 12H10v-2h4v2h3.5L12 17.5zM5.12 5l.81-1h12l.94 1H5.12z"/>
              </svg>
              Archive Project
            </div>
            <div className="project-action-item delete" onClick={() => handleProjectAction('delete', project.id)}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
  ...
  const renderProjectFooter = (project) => (
    <div className="project-footer">
      ...
      <div className="project-stats">
        <span><i className="ri-file-list-line"></i> {project.tasks} tasks</span>
        <span><i className="ri-bar-chart-line"></i> {project.activities} activities</span>
      </div>
    </div>
  );
